    ...
    <main>
      <section className="grid gap-6 lg:grid-cols-[360px_1fr]">
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 shadow-[0_10px_30px_rgba(0,0,0,0.4)]">
          <h1 className="text-lg font-semibold">Random Generator</h1>
          <p className="mt-2 text-sm text-zinc-400">
            Generate a club, rules, objectives, and a wildcard — ready to export as a PNG.
          </p>
          ...
          <div className="mt-5 grid gap-4 text-sm">
            ...
            <p className="text-xs text-zinc-500">
              Want the classic scenarios? Use <span className="text-zinc-300">Preset Challenges</span>.
            </p>
          </div>
        </div>
